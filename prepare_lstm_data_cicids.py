"""
CICIDS2018 için LSTM Sequence Veri Hazırlama
"""
...
def main():
    print("="*80)
    print("🔄 CICIDS2018 - LSTM Veri Hazırlama")
    print("="*80)
    
    # Load processed data
    data_dir = Path('processed_data_cicids')
    ...
    # Save
    output_dir = Path('lstm_data_cicids')
    ...
    print("✨ CICIDS LSTM verisi hazır!")
